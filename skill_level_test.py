...
possible_pieces = ['p','n','b','r','q']
possible_positions = [x for x in range(0,4)]+[x for x in range(5,8)] + [
...
for new_piece in possible_pieces:
    for pos in possible_positions:
        ...
        result = rand_skill_battle("variant1", start_fen, max_games, skill1, skill2).split(" ")
