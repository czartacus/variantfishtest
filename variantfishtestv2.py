...
class EngineMatch:
    ...
    def __init__(self):
        ...
        self.parser.add_argument("-d1", "--depth1",help="maximum plies to evaluate for engine1", type=int, default=13)
        self.parser.add_argument("-d2", "--depth2",help="maximum plies to evaluate for engine2", type=int, default=13)
        ...
        self.depth = [self.depth1,self.depth2]
        self.wt = None
        self.bt = None
        self.scores = [0, 0, 0]
        self.r = []
    ...
    def play_game(self, white, black, pos="startpos"):
        ...
        while True:
            ...
            bestmove, ponder = e.go(wtime=self.wt, btime=self.bt, winc=self.inc, binc=self.inc, depth=self.depth[index])
